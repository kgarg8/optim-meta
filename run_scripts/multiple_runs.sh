python main.py --device=2 --dataset=miniimagenet --alg=MAML --n_inner=5 --lr_sched=True --num_epoch=100 --batch_size=2 --inner_lr=1e-2 --outer_lr=1e-3 --net=functional_net --num_way=5 --num_shot=1 --exp=maml_mini_shot_1_way_5

python main.py --device=2 --dataset=miniimagenet --alg=MAML --n_inner=5 --lr_sched=True --num_epoch=100 --batch_size=2 --inner_lr=1e-2 --outer_lr=1e-3 --net=functional_net --num_way=5 --num_shot=5 --exp=maml_mini_shot_5_way_5 
